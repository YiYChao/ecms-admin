package top.xcck.admin.aspect;

import com.alibaba.fastjson.JSONObject;
import top.xcck.admin.base.MySysUser;
import top.xcck.admin.entity.Log;
import top.xcck.admin.exception.GlobalExceptionHandler;
import top.xcck.admin.util.ToolUtil;
...
public class WebLogAspect {
    ...
    @Pointcut("@annotation(top.xcck.admin.annotation.SysLog)")
    public void webLog(){}
