...
layui.use(['bodyTab','form','element','layer','jquery'],function(){
	...
	function lockPage(){
		...
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							'<div class="admin-header-lock-img"><img src="https://static.mysiteforme.com/3c5b69f4-2e39-4f88-b302-a6eb48e4c43a.jpg"/></div>'+
							'<div class="admin-header-lock-name" id="lockUserName">晓超</div>'+
							'<div class="input_btn">'+
	...
	function showNotice(){
		layer.open({
	        ...
	        btn: ['火速围观'],
	        moveType: 1,
	        content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p>系统更新信息将会在此处进行展示。</p><p>如有纰漏，请多多指教！</p></div>',
